...
class WarehousesTest < ApplicationSystemTestCase
  ...
  test "creating a Warehouse" do
    ...
    fill_in "Company", with: @warehouse.company_id
    fill_in "Description", with: @warehouse.description
    fill_in "Title", with: @warehouse.title
    fill_in "Total size", with: @warehouse.total_size
    fill_in "Youtube url", with: @warehouse.youtube_url
