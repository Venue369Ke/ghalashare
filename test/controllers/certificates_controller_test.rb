...
class CertificatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certificate" do
    assert_difference('Certificate.count') do
      post certificates_url, params: { certificate: { cert_item: @certificate.cert_item, warehouse_id: @certificate.warehouse_id } }
    end
  ...
  test "should update certificate" do
    patch certificate_url(@certificate), params: { certificate: { cert_item: @certificate.cert_item, warehouse_id: @certificate.warehouse_id } }
