...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { equipment_item: @equipment.equipment_item, warehouse_id: @equipment.warehouse_id } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { equipment_item: @equipment.equipment_item, warehouse_id: @equipment.warehouse_id } }
