...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { company_id: @warehouse.company_id, description: @warehouse.description, title: @warehouse.title, total_size: @warehouse.total_size, youtube_url: @warehouse.youtube_url } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { company_id: @warehouse.company_id, description: @warehouse.description, title: @warehouse.title, total_size: @warehouse.total_size, youtube_url: @warehouse.youtube_url } }
