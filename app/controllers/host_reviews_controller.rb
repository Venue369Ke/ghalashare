class HostReviewsController < ApplicationController
  ...
  private
    def host_review_params
      params.require(:host_review).permit(:comment, :star, :warehouse_id, :reservation_id, :guest_id)
    end
end
